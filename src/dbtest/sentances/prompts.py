...
class SentencePromptGenerator:
    ...
    def __complement_objects(self, sentence):
        ...
        elif sentence.direct_object is DirectObject.none and sentence.indirect_pronoun is not IndirectPronoun.none:
            return f"The sentence must have an indirect object as a pronoun in the first clause before the verb {sentence.infinitive}."
        elif sentence.direct_object is not DirectObject.none and sentence.indirect_pronoun is not IndirectPronoun.none:
    ...
    def __detect_objects(self, sentence):
    ...
    def __transform_nouns_to_pronouns(self, sentence):
    ...
    def generate_sentence_prompt(self, sentence) -> str:
        return '\n'.join([
                ...
                self.__detect_objects(sentence),
                self.__transform_nouns_to_pronouns(sentence),
                self.__json_format(),
